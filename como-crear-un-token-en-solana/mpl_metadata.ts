...
async function main() {
  ...
  const myKeypair = loadWalletKey("/home/raul/.config/solana/id.json");
  // Specify the mint (token) public key
  const mint = new web3.PublicKey(
    "EvwA4oHnxqFhAtmNXDxu1wWyzE2R8jesyERxyrzPfT1L"
  );
  ...
  const ourMetadata = {
    name: "Raul",
    symbol: "RSZT",
    uri: "https://raw.githubusercontent.com/0xRSZT/videos/main/como-crear-un-token-en-solana/logo.png",
  };
